...
foreach(_cmake_expected_target IN ITEMS absl::atomic_hook absl::errno_saver absl::log_severity absl::nullability absl::raw_logging_internal absl::spinlock_wait absl::config absl::dynamic_annotations absl::core_headers absl::malloc_internal absl::base_internal absl::base absl::throw_delegate absl::exception_testing absl::pretty_function absl::exception_safety_testing absl::atomic_hook_test_helper absl::spinlock_test_common absl::endian absl::scoped_set_env absl::strerror absl::fast_type_id absl::prefetch absl::algorithm absl::algorithm_container absl::cleanup_internal absl::cleanup absl::btree absl::btree_test_common absl::compressed_tuple absl::fixed_array absl::inlined_vector_internal absl::inlined_vector absl::counting_allocator absl::test_instance_tracker absl::flat_hash_map absl::flat_hash_set absl::node_hash_map absl::node_hash_set absl::container_memory absl::hash_function_defaults absl::hash_generator_testing absl::hash_policy_testing absl::hash_policy_traits absl::common_policy_traits absl::hashtablez_sampler absl::hashtable_debug absl::hashtable_debug_hooks absl::node_slot_policy absl::raw_hash_map absl::container_common absl::raw_hash_set absl::layout absl::tracked absl::unordered_map_constructor_test absl::unordered_map_lookup_test absl::unordered_map_members_test absl::unordered_map_modifiers_test absl::unordered_set_constructor_test absl::unordered_set_lookup_test absl::unordered_set_members_test absl::unordered_set_modifiers_test absl::crc_cpu_detect absl::crc_internal absl::crc32c absl::non_temporal_arm_intrinsics absl::non_temporal_memcpy absl::crc_cord_state absl::stacktrace absl::symbolize absl::examine_stack absl::failure_signal_handler absl::debugging_internal absl::demangle_internal absl::leak_check absl::stack_consumption absl::debugging absl::flags_path_util absl::flags_program_name absl::flags_config absl::flags_marshalling absl::flags_commandlineflag_internal absl::flags_commandlineflag absl::flags_private_handle_accessor absl::flags_reflection absl::flags_internal absl::flags absl::flags_usage_internal absl::flags_usage absl::flags_parse absl::any_invocable absl::bind_front absl::function_ref absl::hash absl::hash_testing absl::spy_hash_state absl::city absl::low_level_hash absl::log_internal_check_impl absl::log_internal_check_op absl::log_internal_conditions absl::log_internal_config absl::log_internal_flags absl::log_internal_format absl::log_internal_globals absl::log_internal_log_impl absl::log_internal_proto absl::log_internal_message absl::log_internal_log_sink_set absl::log_internal_nullguard absl::log_internal_nullstream absl::log_internal_strip absl::log_internal_test_actions absl::log_internal_test_helpers absl::log_internal_test_matchers absl::log_internal_voidify absl::log_internal_append_truncated absl::absl_check absl::absl_log absl::check absl::die_if_null absl::log_flags absl::log_globals absl::log_initialize absl::log absl::log_entry absl::log_sink absl::log_sink_registry absl::log_streamer absl::scoped_mock_log absl::log_internal_structured absl::log_structured absl::memory absl::type_traits absl::meta absl::bits absl::int128 absl::numeric absl::numeric_representation absl::sample_recorder absl::exponential_biased absl::periodic_sampler absl::random_random absl::random_bit_gen_ref absl::random_internal_mock_helpers absl::random_internal_mock_overload_set absl::random_mocking_bit_gen absl::random_distributions absl::random_seed_gen_exception absl::random_seed_sequences absl::random_internal_traits absl::random_internal_distribution_caller absl::random_internal_fast_uniform_bits absl::random_internal_seed_material absl::random_internal_pool_urbg absl::random_internal_explicit_seed_seq absl::random_internal_sequence_urbg absl::random_internal_salted_seed_seq absl::random_internal_iostream_state_saver absl::random_internal_generate_real absl::random_internal_wide_multiply absl::random_internal_fastmath absl::random_internal_nonsecure_base absl::random_internal_pcg_engine absl::random_internal_randen_engine absl::random_internal_platform absl::random_internal_randen absl::random_internal_randen_slow absl::random_internal_randen_hwaes absl::random_internal_randen_hwaes_impl absl::random_internal_distribution_test_util absl::random_internal_uniform_helper absl::status absl::statusor absl::string_view absl::strings absl::strings_internal absl::str_format absl::str_format_internal absl::pow10_helper absl::cord_internal absl::cordz_update_tracker absl::cordz_functions absl::cordz_statistics absl::cordz_handle absl::cordz_info absl::cordz_sample_token absl::cordz_update_scope absl::cord absl::cord_rep_test_util absl::cord_test_helpers absl::cordz_test_helpers absl::graphcycles_internal absl::kernel_timeout_internal absl::synchronization absl::thread_pool absl::per_thread_sem_test_common absl::time absl::civil_time absl::time_zone absl::time_internal_test_util absl::any absl::bad_any_cast absl::bad_any_cast_impl absl::span absl::optional absl::bad_optional_access absl::bad_variant_access absl::conformance_testing absl::variant absl::compare absl::utility absl::if_constexpr)
...
# Create imported target absl::exception_testing
add_library(absl::exception_testing INTERFACE IMPORTED)

set_target_properties(absl::exception_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;GTest::gtest"
)
...
# Create imported target absl::exception_safety_testing
add_library(absl::exception_safety_testing SHARED IMPORTED)

set_target_properties(absl::exception_safety_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::pretty_function;absl::memory;absl::meta;absl::strings;absl::utility;GTest::gtest"
)

# Create imported target absl::atomic_hook_test_helper
add_library(absl::atomic_hook_test_helper SHARED IMPORTED)

set_target_properties(absl::atomic_hook_test_helper PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::atomic_hook;absl::core_headers"
)

# Create imported target absl::spinlock_test_common
add_library(absl::spinlock_test_common SHARED IMPORTED)

set_target_properties(absl::spinlock_test_common PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::base;absl::config;absl::base_internal;absl::core_headers;absl::synchronization;GTest::gtest"
)
...
# Create imported target absl::btree_test_common
add_library(absl::btree_test_common INTERFACE IMPORTED)

set_target_properties(absl::btree_test_common PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::btree;absl::cord;absl::flat_hash_set;absl::strings;absl::time"
)
...
# Create imported target absl::test_instance_tracker
add_library(absl::test_instance_tracker SHARED IMPORTED)

set_target_properties(absl::test_instance_tracker PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::compare"
)
...
# Create imported target absl::hash_generator_testing
add_library(absl::hash_generator_testing SHARED IMPORTED)

set_target_properties(absl::hash_generator_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_policy_testing;absl::memory;absl::meta;absl::strings"
)

# Create imported target absl::hash_policy_testing
add_library(absl::hash_policy_testing INTERFACE IMPORTED)

set_target_properties(absl::hash_policy_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash;absl::strings"
)
...
# Create imported target absl::tracked
add_library(absl::tracked INTERFACE IMPORTED)

set_target_properties(absl::tracked PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config"
)

# Create imported target absl::unordered_map_constructor_test
add_library(absl::unordered_map_constructor_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_map_constructor_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)

# Create imported target absl::unordered_map_lookup_test
add_library(absl::unordered_map_lookup_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_map_lookup_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)

# Create imported target absl::unordered_map_members_test
add_library(absl::unordered_map_members_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_map_members_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::type_traits;GTest::gmock"
)

# Create imported target absl::unordered_map_modifiers_test
add_library(absl::unordered_map_modifiers_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_map_modifiers_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)

# Create imported target absl::unordered_set_constructor_test
add_library(absl::unordered_set_constructor_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_set_constructor_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)

# Create imported target absl::unordered_set_lookup_test
add_library(absl::unordered_set_lookup_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_set_lookup_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)

# Create imported target absl::unordered_set_members_test
add_library(absl::unordered_set_members_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_set_members_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::type_traits;GTest::gmock"
)

# Create imported target absl::unordered_set_modifiers_test
add_library(absl::unordered_set_modifiers_test INTERFACE IMPORTED)

set_target_properties(absl::unordered_set_modifiers_test PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::hash_generator_testing;absl::hash_policy_testing;GTest::gmock"
)
...
# Create imported target absl::stack_consumption
add_library(absl::stack_consumption SHARED IMPORTED)

set_target_properties(absl::stack_consumption PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::raw_logging_internal"
)
...
# Create imported target absl::log_internal_test_actions
add_library(absl::log_internal_test_actions SHARED IMPORTED)

set_target_properties(absl::log_internal_test_actions PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::log_entry;absl::log_severity;absl::strings;absl::time"
)

# Create imported target absl::log_internal_test_helpers
add_library(absl::log_internal_test_helpers SHARED IMPORTED)

set_target_properties(absl::log_internal_test_helpers PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::log_globals;absl::log_initialize;absl::log_internal_globals;absl::log_severity;GTest::gtest"
)

# Create imported target absl::log_internal_test_matchers
add_library(absl::log_internal_test_matchers SHARED IMPORTED)

set_target_properties(absl::log_internal_test_matchers PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::core_headers;absl::log_entry;absl::log_internal_test_helpers;absl::log_severity;absl::strings;absl::time;GTest::gtest;GTest::gmock"
)
...
# Create imported target absl::random_internal_mock_overload_set
add_library(absl::random_internal_mock_overload_set INTERFACE IMPORTED)

set_target_properties(absl::random_internal_mock_overload_set PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::random_mocking_bit_gen;absl::random_internal_mock_helpers"
)
...
# Create imported target absl::random_internal_explicit_seed_seq
add_library(absl::random_internal_explicit_seed_seq INTERFACE IMPORTED)

set_target_properties(absl::random_internal_explicit_seed_seq PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::endian"
)

# Create imported target absl::random_internal_sequence_urbg
add_library(absl::random_internal_sequence_urbg INTERFACE IMPORTED)

set_target_properties(absl::random_internal_sequence_urbg PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config"
)
...
# Create imported target absl::pow10_helper
add_library(absl::pow10_helper SHARED IMPORTED)
...
# Create imported target absl::cord_rep_test_util
add_library(absl::cord_rep_test_util INTERFACE IMPORTED)

set_target_properties(absl::cord_rep_test_util PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::cord_internal;absl::raw_logging_internal;absl::strings"
)
...
# Create imported target absl::cordz_test_helpers
add_library(absl::cordz_test_helpers INTERFACE IMPORTED)

set_target_properties(absl::cordz_test_helpers PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::config;absl::cord;absl::cord_internal;absl::cordz_info;absl::cordz_sample_token;absl::cordz_statistics;absl::cordz_update_tracker;absl::core_headers;absl::strings"
)
...
# Create imported target absl::thread_pool
add_library(absl::thread_pool INTERFACE IMPORTED)

set_target_properties(absl::thread_pool PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::any_invocable;absl::core_headers;absl::synchronization"
)

# Create imported target absl::per_thread_sem_test_common
add_library(absl::per_thread_sem_test_common SHARED IMPORTED)

set_target_properties(absl::per_thread_sem_test_common PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::synchronization;absl::base;absl::config;absl::strings;absl::time;GTest::gmock"
)
...
# Create imported target absl::time_internal_test_util
add_library(absl::time_internal_test_util SHARED IMPORTED)

set_target_properties(absl::time_internal_test_util PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::time;absl::config;absl::raw_logging_internal;absl::time_zone"
)
...
set_target_properties(absl::conformance_testing PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_14"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "absl::algorithm;absl::debugging;absl::type_traits;absl::strings;absl::utility;GTest::gmock_main"
)
